...
public final class SdoPrint
{
  ...
  public static void main(String args[]) throws Exception
  {
    ...
    String  connectionString  = "jdbc:oracle:thin:@127.0.0.1:1521:indoor";//args[0];
    String  userName          = "indooradmin";//args[1];
    String  userPassword      = "indoor";//args[2];
    String  tableName         = "cad";//args[3];
    String  geoColumn         = "geoC";//args[4];
    String  predicate         = "";//args[5];
    int     printStyle        = 4;//Integer.parseInt(args[6]);
    boolean fastUnpickle      = false;//(args.length > 7 ? (Integer.parseInt(args[7])==1) : false);
